...
class TextRewriteService:
    ...
    def _convert_first_to_third_person(self, text: str) -> str:
        """Convert first-person sentences to third-person"""
        replacements = {
            r"\b[Ii] am\b": "The author is",
            r"\b[Ii] was\b": "The writer was",
            r"\b[Ii] have\b": "The individual has",
            r"\b[Ii] had\b": "The person had",
            r"\b[Ii] think\b": "It is believed",
            r"\b[Ii] believe\b": "It is considered",
            r"\b[Ii] feel\b": "It is felt",
            r"\b[Ii] suggest\b": "It is suggested",
            r"\b[Ii] recommend\b": "It is recommended",
            r"\b[Ii] conclude\b": "It can be concluded",
            r"\b[Ii] will\b": "It will",
            r"\b[Ii] can\b": "It can",
            r"\bmy\b": "the",
            r"\bme\b": "the author",
            r"\bmine\b": "the author's",
            r"\bwe\b": "they",
            r"\bus\b": "them",
            r"\bour\b": "their",
            r"\bours\b": "theirs"
